...
```private/greatest-player-by-wins``` POST request for a specific player from a specific game the client created. Token is used for authentication and querying data.
